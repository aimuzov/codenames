...
// На iOS вибрации нет — там настройка принудительно выключена и заблокирована в UI.
export const hapticsEnabledAtom = atom((saved.haptics ?? true) && hapticsSupported(), 'hapticsEnabled')
...
export const cardWordSizeAtom = atom<CardWordSize>(normalizeSize(saved.cardWordSize), 'cardWordSize')
...
export const setHaptics = action((v: boolean) => {
  hapticsEnabledAtom.set(v)
  persist()
}, 'setHaptics')
