...
export const TILE = 'relative flex min-h-[4rem] items-center justify-center overflow-hidden rounded-lg px-1 py-1.5 text-center'
  ...
  return (
    ...
    >
      ...
      {foreign && card.openedBy && (
        <span
          className={cn('absolute right-2 bottom-1.5 size-1 rounded-full', OPENED_DOT[card.openedBy])}
        />
      )}
    </button>
  )
