	...
	return (
		<Screen bottomFade onBack={back} header={<TopBar title="Правила" onBack={back} />}>
			<div className="flex flex-col gap-5">
				...
				<Rule title="Поле">
					На столе 25 слов. У начинающей команды 9 своих карт, у второй — 8. Ещё 7 нейтральных и 1
					«ассасин» — его открывать нельзя.
				</Rule>
				...
				<Rule title="Ассасин">Если открыть карту-ассасина, команда сразу проигрывает.</Rule>
